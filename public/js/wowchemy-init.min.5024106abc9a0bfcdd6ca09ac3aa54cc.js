(() => {
  ...
  (() => {
    ...
    }), i(), window.PlotlyConfig = { MathJaxConfig: "local" }, Object.keys(localStorage).forEach(function(e2) {
      /^wc-announcement-/.test(e2) && (document.documentElement.setAttribute("data-wc-announcement-status", "dismissed"), console.debug("Hiding announcement..."));
    });
  })();
})();
